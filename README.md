...
Simple app that is able to search artist and their's albums and save albums locally. 
It uses Lastfm public API. App is build as an example of MVVM architecture.
